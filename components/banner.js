      ...
      <div className="absolute inset-0 bg-black bg-opacity-[50%] flex flex-col items-center justify-center text-white">
        ...
        <p className="text-xl md:text-2xl mb-10 text-center max-w-2xl">
          ...
          <span className="mt-4 inline-flex space-x-2 text-3xl">
            <span className="font-bold text-yellow-400 animate-scale-yellow">
              EVALUATION
            </span>
            <span>|</span>
            <span className="font-bold text-green-400 animate-scale-green">
              AUDIT
            </span>
            <span>|</span>
            <span className="font-bold text-red-400 animate-scale-red">
              AUTHENTICATION
            </span>
          </span>
        </p>
